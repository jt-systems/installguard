...
fn signal_kind(s: &Signal) -> String {
    match s {
        ...
        Signal::ProvenanceClaimed { .. } => "provenance_claimed",
        Signal::AdvisoryKnown { .. } => "advisory_known",
        Signal::ProjectMetadata { .. } => "project_metadata",
        Signal::ScorecardScore { .. } => "scorecard_score",
